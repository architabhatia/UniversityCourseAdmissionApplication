...
public class ApplicantServiceImpl implements IApplicantService {
	...
	@Transactional
	@Override
	public ApplicantModel viewApplicant(Long applicantId) throws ApplicantNotFoundException {
		ApplicantEntity applicant = applicantRepo.findById(applicantId).orElse(null);
		if (applicant == null) {
			throw new ApplicantNotFoundException("Applicant with id "+ applicantId +"doesn't exists");
		} else
			return parser.parse(applicantRepo.findById(applicantId).get());
	}
