...
public class ApplicantRestController {
	...
	public ResponseEntity<Boolean> removeApplicant(@PathVariable("ApplicantId") Long applicantId) throws ApplicantNotFoundException {
	...
	public ResponseEntity<ApplicantModel> updateApplicant(@RequestBody ApplicantModel applicant) throws ApplicantNotFoundException {
		return new ResponseEntity<>(applicantService.updateApplicant(applicant),HttpStatus.OK);
	...
	public ResponseEntity<ApplicantModel> addApplicant(@RequestBody ApplicantModel Applicant)throws ApplicantNotFoundException {
		return new ResponseEntity<>(applicantService.registerApplicant(Applicant), HttpStatus.OK);
	}
