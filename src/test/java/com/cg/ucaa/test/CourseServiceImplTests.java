...
class CourseServiceImplTests {
	...
	void testViewAllCourses() {
		...
		UniversityStaffMemberModel model = new UniversityStaffMemberModel(1L, "dean@1234", "Full Stack Trainer");
		...
		List<CourseModel> expected = Arrays.asList(new CourseModel[] {
				new CourseModel(1L, "Java CORE", "3 Months", LocalDate.parse("2021-05-01"),
						LocalDate.parse("2021-08-10"), "3500",model),
	...
	/**
	 * Test Case 4 - adding the course in the university
	 */
	@Test
	@DisplayName("CourseServiceImpl::saveCourse should return course saved with given courseId")
	void testAddCourse() throws CourseNotFoundException {
		UniversityStaffMemberEntity entity = new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer");
		UniversityStaffMemberModel model = new UniversityStaffMemberModel(1L, "dean@1234", "Full Stack Trainer");
		
		CourseEntity testData = new CourseEntity(5L, "Hibernate", "3 Months", LocalDate.parse("2021-05-01"),
				LocalDate.parse("2021-08-10"), "3500",entity);
		CourseModel expected = new CourseModel(5L, "Hibernate", "3 Months", LocalDate.parse("2021-05-01"),
				LocalDate.parse("2021-08-10"), "3500",model);

		Mockito.when(repo.save(testData)).thenReturn(testData);
		CourseModel actual = csImpl.addCourse(expected);

		assertEquals(expected, actual);
	}

	/**
	 * Test Case 5 - removing the course in the university
	 */
	@Test
	...
	/**
	 * Test Case 6 - updating the course in the university
	 */
	@Test
	@DisplayName("CourseServiceImpl::updateCourse should update course with given courseId")
	void testUpdateCourse() throws CourseNotFoundException {
		UniversityStaffMemberEntity entity = new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer");
		UniversityStaffMemberModel model = new UniversityStaffMemberModel(1L, "dean@1234", "Full Stack Trainer");
		CourseEntity testData = new CourseEntity(1L, "Hibernate", "1 Months", LocalDate.parse("2021-05-01"),
				LocalDate.parse("2021-08-10"), "1500",entity);
		CourseModel expected = new CourseModel(1L, "Spring MVC", "1 Months", LocalDate.parse("2021-05-01"),
				LocalDate.parse("2021-08-10"), "1500",model);
		
		testData.setCourseName("Spring MVC");
	...
	/**
	 * Test Case 7 - facilitating null if no courses are present
	 */
	@Test
