...
class UniversityStaffServiceImplTests {
	...
	void testViewAllStaffs() {
		...
		List<UniversityStaffMemberEntity> testData = Arrays.asList(new UniversityStaffMemberEntity[] {
				new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer"),
				new UniversityStaffMemberEntity(2L, "Ak#@135", "Professor") });
		...
		List<UniversityStaffMemberModel> expected = Arrays.asList(new UniversityStaffMemberModel[] {
				new UniversityStaffMemberModel(1L, "dean@1234", "Full Stack Trainer"), 
				new UniversityStaffMemberModel(2L, "Ak#@135", "Professor")});
	...
	void testViewStaff() throws UniversityStaffMemberNotFoundException {
		...
		UniversityStaffMemberEntity testdata = new UniversityStaffMemberEntity(1L, "dean@1234", "HOD");
		UniversityStaffMemberModel expected = new UniversityStaffMemberModel(1L, "dean@1234", "HOD");
	...
	void testAddUniversityStaff() throws UniversityStaffMemberNotFoundException {
		...
		UniversityStaffMemberEntity testdata = new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer");
		UniversityStaffMemberModel expected = new UniversityStaffMemberModel(1L, "dean@1234", "Full Stack Trainer");
	...
	void testUpdateUniversityStaff() throws UniversityStaffMemberNotFoundException {
		...
		UniversityStaffMemberEntity testData = new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer");
		UniversityStaffMemberModel expectedData = new UniversityStaffMemberModel(1L, "dean1234", "Full Stack Trainer");
		
		testData.setPassword("dean1234");
